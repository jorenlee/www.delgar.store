                ...
                <div class="lg:space-y-3 space-y-1" v-if="j.status !== 'NA'">
                  ...
                  >
                    ...
                    <div class="flex items-center justify-between lg:mt-0 mt-3">
                      <span class="text-xs lg:text-sm text-gray-600 lg:flex hidden"
                        >Quantity</span
                      >
                       <span class="text-xs lg:text-sm text-gray-600 lg:hidden flex"
                        >QTY</span
                      >
      ...
      >
        <div class="lg:p-3 p-2">
          <div class="flex items-center mb-3">
            ...
            <!-- Selected Indicator -->
            <div 
              v-if="orderInfo.payment_method === 'Bank Transfer'"
              class="ml-auto"
            >
              <i class="fa fa-check-circle text-yellow-400 text-lg"></i>
            </div>
