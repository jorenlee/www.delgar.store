...
watch(
  ...
  (newMethod) => {
    if (newMethod === "CASH") {
      ...
      orderInfo.value.delivery_fee = "0";
      orderInfo.value.delivery_address =
        "JP Rizal Avenue, In front of Penshoppe beside Sanbon Enterprises, Purok 4 Carmen Annex, Ozamiz City, Philippines";
      orderInfo.value.receipt_url = "https://www.delgar.store";
      ...
      <div class="overflow-y-auto bg-white w-full">
        ...
        >
          <div class="lg:flex lg:w-11/12 w-full mx-auto">
            ...
            <div
              class="flex items-center justify-between lg:w-6/12 relative w-full py-4"
            >
              <!-- Logo -->
        ...
        >
          ...
          <div
            class="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 lg:gap-4 gap-1 mb-10"
          >
            <div
            ...
            >
              ...
              <div class="relative aspect-square overflow-hidden bg-gray-100">
                <img
                  v-if="j.product_image && j.product_image.length"
                  :src="j.product_image[0].url.split(/(?<=\.(jpg|png))/i)[0]"
                  :alt="j.product_image[0].name"
              ...
              <div class="p-2 lg:p-4">
                <div class="mb-3">
                  ...
                  <h3
                    class="text-sm font-semibold text-[#000] line-clamp-2 capitalize leading-0 flex"
                  >
                    {{ j.product_name }}
                  </h3>
                </div>
                ...
                <div class="lg:space-y-3 space-y-1" v-if="j.status !== 'NA'">
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        <span
                          class="text-xs font-medium text-gray-600 uppercase tracking-wide leading-none flex"
                          >Retail</span
                        >
                    ...
                    <div class="flex items-center justify-between lg:mt-0 mt-3">
                      <span
                        class="text-xs lg:text-sm text-gray-600 lg:flex hidden"
                        >Quantity</span
                      >
                      <span
                        class="text-xs lg:text-sm text-gray-600 lg:hidden flex"
                        >QTY</span
                      >
                      <div class="flex items-center lg:space-x-2">
                        ...
                        >
                          <svg
                            class="w-3 h-3 lg:w-4 lg:h-4 text-black hover:text-white"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
        ...
        <footer class="bg-[#183853] text-white text-xs">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div
              class="flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left"
            >
              <!-- Footer Logo -->
              ...
              <div class="flex-1">
                <p class="font-semibold text-sm">
                  ©
                  <a href="https://www.delgar.store" class="hover:underline"
                    >www.delgar.store</a
                  >
                </p>
                <p
                  class="font-sans flex items-center justify-center md:justify-start mt-2"
                >
                  <i class="fa fa-map-marker mr-2 lg:flex hidden"></i>
                  JP Rizal Avenue, In front of Penshoppe, beside Sanbon
                  Enterprises, Purok 4 Carmen Annex, Ozamiz City
                </p>
                <p
                  class="font-sans flex items-center justify-center md:justify-start mt-2"
                >
              ...
              <div class="mt-2 md:mt-0">
                <a
                  href="https://www.facebook.com/DelgarFrozenProducts"
                  target="_blank"
                  rel="noopener"
                        ...
                        >
                          <div class="lg:p-3 p-2">
                            <div class="flex items-center mb-3">
                              ...
                              />
                              <span
                                class="text-white font-semibold whitespace-nowrap lg:text-sm text-xs"
                              >
                                GCASH Transfer
                              </span>
                              <!-- Selected Indicator -->
                              <div
                                v-if="orderInfo.payment_method === 'GCash'"
                                class="ml-auto"
                              >
                                <i
                                  class="fa fa-check-circle text-yellow-400 text-lg"
                                ></i>
                              </div>
                            </div>
                            <img
                        ...
                        >
                          <div class="lg:p-3 p-2">
                            <div class="flex items-center mb-3">
                              ...
                              />
                              <span
                                class="text-[#fff] font-semibold whitespace-nowrap lg:text-sm text-xs"
                              >
                                CASH
                              </span>
                              <!-- Selected Indicator -->
                              <div
                                v-if="orderInfo.payment_method === 'CASH'"
                                class="ml-auto"
                              >
                                <i
                                  class="fa fa-check-circle text-yellow-400 text-lg"
          ...
          <div class="p-3 bg-white">
            ...
            />
                  ...
                  >
                    <i
                      v-if="!isSubmitting"
                      class="fa-solid fa-paper-plane text-white text-base"
                    ></i>
                    <i
                      v-else
                      class="fa-solid fa-spinner fa-spin text-white text-base"
                    ></i>
            ...
            >
              <div
                class="bg-white rounded-2xl shadow-2xl px-3 py-5 text-center max-w-lg w-full border border-gray-100"
              >
                ...
                <div class="my-8 relative">
                  ...
                  >
                    <i
                      class="fa fa-check-circle text-4xl lg:text-5xl text-green-500"
                    ></i>
                  </div>
                  <div
